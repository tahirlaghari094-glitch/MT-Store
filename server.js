...
app.post('/api/products', async (req, res) => {
    ...
    if (!title || !price || (!imageBase64 && (!imageUrls || imageUrls.length === 0)) || !paymentDetails || !transactionId) {
    ...
    try {
        ...
        const newProduct = new Product({
            ...
            imageUrl: imageBase64 || (imageUrls && imageUrls[0]) || '',
            imageUrls: imageUrls || [imageBase64],
