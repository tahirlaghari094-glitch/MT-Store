...
// Vercel ke liye isko async banana lazmi tha taakay execution freeze na ho
...
app.post('/api/products', async (req, res) => {
    ...
    try {
        ...
        // Fixed Live URL Domain Route for Vercel
        ...
        // Email send hone ka wait karna lazmi hai
...
app.post('/api/orders', async (req, res) => {
    ...
    try {
        for (const item of items) {
            ...
            // Serverless timeouts se bachne ke liye sequential await triggers
